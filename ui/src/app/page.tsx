      ...
      <div className="relative z-10 min-h-screen flex flex-col">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              <div className="relative">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-red-500 to-red-600 rounded-xl flex items-center justify-center shadow-lg shadow-red-600/25">
                  <span className="text-white font-black text-sm sm:text-lg tracking-tighter">
                    F1
                  </span>
                </div>
          ...
          <div className="flex-1 backdrop-blur-xl bg-white/5 rounded-2xl sm:rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="h-[calc(100vh-240px)] sm:h-[calc(100vh-280px)] overflow-y-auto p-4 sm:p-8 space-y-4 sm:space-y-6 chat-container">
                ...
                <div className="flex flex-col items-center justify-center h-full text-center space-y-8">
                  ...
                  <div className="space-y-4 max-w-lg">
                    ...
                    <p className="text-gray-400 text-lg leading-relaxed">
                      Ask me anything about drivers, teams, races, or
                      championships. I have comprehensive data from recent F1
                      seasons.
                    </p>
              ...
              {messages.map((message) => (
                ...
                >
                  <div
                    className={`flex items-start space-x-3 max-w-2xl ${message.isUser ? "flex-row-reverse space-x-reverse" : ""}`}
                  >
                        ...
                        <div className="mt-4 pt-3 border-t border-white/20">
                          ...
                          <div className="space-y-2">
                            {message.sources.map((source, index) => (
                              <div
                                key={index}
                                className="text-xs bg-black/20 rounded-lg px-3 py-2 border border-white/10"
                              >
        ...
        <footer className="text-center py-6">
          <p className="text-gray-500 text-sm font-medium">
            Powered by <span className="text-red-400">AWS Bedrock</span> &{" "}
            <span className="text-red-400">OpenRouter</span> with comprehensive
            F1 data
          </p>
        </footer>
      </div>
